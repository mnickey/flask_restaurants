...
class webServerHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        try:
            ...
            # Objective 4 -- Create the EDIT page
            ...
            # Objective 5 -- Deleting a restaurant
    ...
    def do_POST(self):
        try:
            # adding delete info to POST method
            if self.path.endswith("/delete"):
                restaurantIDPath = self.path.split("/")[2]
            ...
            # adding edit info into POST request -- probably should be a PUT request though
            if self.path.endswith("/edit"):
